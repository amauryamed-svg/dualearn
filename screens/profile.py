        ...
        controls=[
            ...
            ft.Container(
                content=ft.Column([
                    ...
                    ft.Row([
                        ft.Image(src="/swisscontact_logo.svg", width=100, height=30, fit=ft.ImageFit.CONTAIN),
                        ft.Container(width=1, height=16, bgcolor=BORDER_SUBTLE),
                        ft.Image(src="/bogota_logo.svg", width=110, height=32, fit=ft.ImageFit.CONTAIN),
                        ft.Container(width=1, height=16, bgcolor=BORDER_SUBTLE),
                        ft.Image(src="/bogota_logo.svg", width=110, height=32, fit=ft.ImageFit.CONTAIN),
